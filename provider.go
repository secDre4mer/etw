...
//sys enumerateProviderFieldInformation(guid *windows.GUID, fieldType EventFieldType, buffer *providerFieldInfoArray, bufferSize *uint32) (ret error) = tdh.TdhEnumerateProviderFieldInformation
